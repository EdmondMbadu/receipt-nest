...
export const SITE_NAME = 'ReceiptNest';
...
export const publicPages: readonly PublicPage[] = [
  ...
  },
  {
    ...
    title: 'ReceiptNest Pricing — Free & Pro Receipt Plans',
    description: 'Compare ReceiptNest plans: start with up to 50 receipts and CSV export, or choose Pro for unlimited receipts and additional export and insight features.'
  },
  {
    path: '/security', kind: 'information', label: 'Data handling', updated: CONTENT_REVIEW_DATE,
    title: 'How ReceiptNest Handles Your Receipt Data',
    description: 'Understand receipt storage, cloud AI processing, account access, exports, and deletion requests before choosing ReceiptNest.'
  },
  {
    path: '/about', kind: 'information', label: 'About', updated: CONTENT_REVIEW_DATE,
    title: 'About ReceiptNest — The Receipt-First Workspace',
  ...
  },
  {
    ...
    title: 'ReceiptNest Support — Receipt Uploads, Exports & Accounts',
    description: 'Find help with receipt uploads, email forwarding, CSV exports, and your ReceiptNest account. Contact the support team when you need assistance.'
  },
  {
    path: '/terms', kind: 'terms', label: 'Terms', updated: '2026-05-23',
    title: 'Terms and Conditions | ReceiptNest',
    description: 'Read the Terms and Conditions for using ReceiptNest to capture, organize, review, and export receipt records.'
  }
];
